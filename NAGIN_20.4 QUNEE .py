...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            NAGIN ADRITA
\033[1;37m Facebook:            NAGIN ADRITA
\033[1;37m Github  :            NAGIN-QUNNE
\033[1;37m Version :            20.4
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://Let's chat on WhatsApp! It's a fast, simple, and secure app we can use to message and call each other for free. Get it at https://whatsapp.com/dl/
...
"
        ...
        os.system('https://facebook.com/groups/590061332501716/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
